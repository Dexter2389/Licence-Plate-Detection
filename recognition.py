...
def preprocess(image):
    ...
    imgBlurred = cv2.GaussianBlur(image, (5, 5), 0)
...
def cleanPlate(plate):
    ...
    im1, contours, hierarchy = cv2.findContours(
        ...
        if validateRotationAndRatio(min_rect):
            ...
            if(isMaxWhite(plate_img)):
                ...
                if rect:
                    ...
                    """if we want to tessaract to recognise stuff uncomment the three lines below this"""
